      ...
      <nav className="bg-white border-b border-gray-300 shadow-sm">
        <div className="container mx-auto px-2 py-1 flex justify-between items-center">
          <div className="flex space-x-8">
            <Link href="/FocalPerson/dashboard" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
              <span className="text-2xl text-blue-500 mb-2"><FaHome /></span>
              <span className="text-sm">Dashboard</span>
            </Link>
            <Link href="/FocalPerson/FocalPersonProfile" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
              <span className="text-2xl text-black mb-2"><FaUser /></span>
              <span className="text-sm">Your Profile</span>
            </Link>
            <Link href="/FocalPerson/Internship" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
            ...
            <Link href="/FocalPerson/Department" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
              <span className="text-2xl text-red-500 mb-2"><FaFolder /></span>
              <span className="text-sm">Departments & Programs</span>
              <span className="text-sm text-gray-700 ml-1"><MdKeyboardArrowDown /></span>
            </Link>
            <Link href="/FocalPerson/Faculty" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
              <span className="text-2xl text-purple-500 mb-2"><FaChalkboardTeacher /></span>
              <span className="text-sm">Faculty Directory</span>
            </Link>
            <Link href="/FocalPerson/student" className="flex flex-col items-center text-gray-700 hover:text-white hover:bg-green-500 px-3 py-2 rounded">
