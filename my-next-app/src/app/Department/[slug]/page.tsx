...
export default function DepartmentDetail() {
  ...
  const handleEditFaculty = (faculty: Faculty) => {
    ...
    const editUrl = `/FacultyForm/${encodeURIComponent(id)}?edit=true&facultyId=${encodeURIComponent(faculty._id)}&readOnlyName=${encodeURIComponent(faculty.name)}&readOnlyCnic=${encodeURIComponent(faculty.cnic)}`;
    router.push(editUrl);
  };

  const handleViewFaculty = (faculty: Faculty) => {
    router.push(`/FacultyView/${faculty._id}`);
  };
