...
export default function FacultyForm() {
  ...
  // State for holding the faculty data
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    if (!id) {
      setMessage("Faculty ID is missing")
  ...
  const fetchFacultyData = async () => {
    try {
      ...
      setFaculty({
        ...
        email: data.email,
        isCoreComputingTeacher: data.isCoreComputingTeacher,
        lastAcademicQualification: {
          degreeName: data.lastAcademicQualification.degreeName,
          degreeType: data.lastAcademicQualification.degreeType,
          fieldOfStudy: data.lastAcademicQualification.fieldOfStudy,
          degreeAwardingCountry: data.lastAcademicQualification.degreeAwardingCountry,
          degreeAwardingInstitute: data.lastAcademicQualification.degreeAwardingInstitute,
          degreeStartDate: data.lastAcademicQualification.degreeStartDate,
          degreeEndDate: data.lastAcademicQualification.degreeEndDate
        }
      })
    } catch (error) {
