...
import { Calendar, Clock, Award, FileText, User, ArrowLeft, Download, Check } from "lucide-react"
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch task details
        const taskResponse = await fetch(`/api/task/${slug}`)
        ...
        const internshipResponse = await fetch(`/api/internships/${taskData.internshipId}`)
